...
variable "resource_group" {
  default = "rg_sb_southeastasia_221777_3_172665478844"
}
...
variable "kubeletidentity_object_id" {
  default = "1b731462-648c-49d5-a3b8-d159e7b34ad8"
}
...
resource "azurerm_key_vault_access_policy" "aks_key_vault_access_policy_sea" {
...
resource "azurerm_key_vault_access_policy" "kubelet_key_vault_access_policy_sea" {
  key_vault_id = data.azurerm_key_vault.existing_key_vault.id
  tenant_id    = var.tenant_id
...
resource "azurerm_key_vault_secret" "my_secret_sea" {
  name         = "MySecretsea"  # Secret Name
  value        = "SuperSecretValuesea"  # Secret Value
...
output "key_vault_secret_name" {
  value = azurerm_key_vault_secret.my_secret_sea.name
}

output "key_vault_secret_id" {
  value = azurerm_key_vault_secret.my_secret_sea.id
}