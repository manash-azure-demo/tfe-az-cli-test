...
variable "resource_group" {
  default = "rg_sb_eastus_221777_1_173078341142"
}

# -- az rest --method GET --url "https://graph.microsoft.com/v1.0/me" --query id -o tsv --
variable "user_principal_id" {
  type = string
  default = "46e3889c-d650-4a10-9191-7e6e1a7d424d"
}

## CHANGE THE Key Vault Name HERE -- az keyvault list --query "[].{Name:name, Location:location, ResourceGroup:resourceGroup}" --output table"
variable "key_vault_name" {
  type = string
  default = "mykeyvaultZs"
}

## az aks show --resource-group rg_sb_eastus_221777_1_173078341142 --name mkd-aks-cls1-eus --query "identityProfile.kubeletidentity.objectId" or az aks show --resource-group rg_sb_eastus_221777_1_172709422181 --name mkd-aks-cls1-eus --query "identityProfile" or '#####

variable "kubeletidentity_object_id_cls1" {
  default = "08f82260-f3a0-4931-a73c-6839877738b5"
}

variable "kubeletidentity_object_id_cls2" {
  default = "0d4742c4-7f56-45aa-ac21-bfc4d512d80b"
}
################################# Variable change End ######################################
